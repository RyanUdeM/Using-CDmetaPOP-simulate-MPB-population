...
accu<-30 #10year senario use 2; 20year use 5; 40year use 10;
nbr.loc<-100
...
for(j in 0:9){
  ...
  directory<-paste("F:/Ryan(simulations)/simulation_grid_nolimit/40y_nolimit/40y_81x81_3x3_dis899_k30/replicat",j,sep = "")
  setwd(directory)
